...
if __name__ == "__main__": 
    ...
    crawler.crawl('https://en.wikipedia.org/wiki/Wikipedia:Red_link#Creating_red_links', no_cache=re.compile('^/$').match)
    # displays the urls
    print crawler.content['en.wikipedia.org/w/index.php?title=This_article_does_not_exist&action=edit&redlink=1'].keys()
